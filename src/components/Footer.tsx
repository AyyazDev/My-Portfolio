...
>
  <div className="flex items-center justify-between py-6 footer-inner">
    {/* Logo */}
    <NavLink
      to="/"
      className="logo text-[1.5rem] font-[Red_Hat_Display] no-underline"
      style={{
        color: theme === "dark" ? "white" : "black",
        textDecoration: "none",
        marginLeft: "8rem"
